...
//   - You MUST implement AVTWindowSheetControllerDelegate's method
...
@protocol AVTWindowSheetControllerDelegate
- (void)avt_systemRequestsVisibilityForView:(NSView*)view;
@end


@interface AVTWindowSheetController : NSObject {
 @private
  __weak NSWindow* window_;
  __weak NSView* activeView_;
  __weak id <AVTWindowSheetControllerDelegate> delegate_;
